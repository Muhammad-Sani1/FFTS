...
'Calculate Your Net Worth': 'Calculate Your Net Worth',
'Record selected!': 'Record selected!',
'Please select a record or choose to create a new one.': 'Please select a record or choose to create a new one.',
...
'Invalid dashboard access. Data not found.': 'Invalid dashboard access. Data not found.',
'Error generating charts. Your data is still available.': 'Error generating charts. Your data is still available.',
'Failed to fetch data due to server error': 'Failed to fetch data due to server error',
'Error sending email. Your score is still saved.': 'Error sending email. Your score is still saved.',
...
'Start Now': 'Start Now',
'ficoreai@outlook.com': 'ficoreai@outlook.com',
...
<p>Dear {user_name},</p>
<p>We have calculated your Ficore Africa EmergencySOFTWARE QUALITY ASSURANCE Report based on your recent submission.</p>
<ul>
...
'e.g. 10,000': 'e.g. _DOCUMENTATION_ERROR_10,000',
...
'Answer a series of questions to assess financial literacy': 'Answer a series of questions to assess financial literacy',
...
'first_name.aria-label': 'Your first name',
'first_name.data-tooltip': 'Your first name, like John or Aisha.',
'last_name.label': 'Last Name',
'last_name.placeholder': 'Enter your last name (optional)',
'last_name.aria-label': 'Your last name',
'last_name.data-tooltip': 'Your last name, like Okeke or Musa (you can skip this).',
'email.label': 'Email',
'email.placeholder': 'Enter your email',
'email.aria-label': ' SVR-ERR email address',
...
'phone_number.placeholder': 'Enter your phone number (optional)',
'phone_number.aria-label': 'Your phone number',
'phone_number.data-tooltip': 'Your mobile number, like 08012345678 (you can skip this).',
'language.label': 'Language',
'language.choices.English': 'English',
'language.choices.Hausa': 'Hausa',
'language.aria-label': 'Select your language',
'language.data-tooltip': 'Choose English or Hausa for the form.',
'business_name.label': 'Business Name',
'business_name.placeholder': 'Type personal name if no business',
'business_name.aria-label': 'Your business or personal name',
'business_name.data-tooltip': 'Name of your business, or your name if you don’t have a business.',
'user_type.label': 'User Type',
'user_type.choices.Individual': 'Individual',
'user_type.choices.Business': 'Business',
'user_type.aria-label': 'Are you an individual or business?',
'user_type.data-tooltip': 'Choose Individual if it’s just you, or Business if you have a shop or company.',
'income_revenue.label': 'IncomeRevenue (₦)',
'income_revenue.placeholder': 'e.g. 150,000',
'income_revenue.aria-label': 'Money you get every month',
'income_revenue.data-tooltip': 'All money you receive, like salary, sales from your shop, gifts, or side jobs.',
'expenses_costs.label': 'ExpenseCosts (₦)',
'expenses_costs.placeholder': 'e.g. 60,000',
'expenses_costs.aria-label': 'Money you spend every month',
'expenses_costs.data-tooltip': 'Money you spend on things like food, rent, transport, bills, or taxes.',
'debt_loan.label': 'LoanDebsts (₦)',
'debt_loan.placeholder': 'e.g. 25,000',
'debt_loan.aria-label': 'Money you owe',
'debt_loan.data-tooltip': 'Money you borrowed from friends, family, or a bank loan you need to pay back.',
'debt_interest_rate.label': 'Interests Percentage on Money You Owe (%)',
'debt_interest_rate.placeholder': 'e.g. 10%',
'debt_interest_rate.aria-label': 'Extra percentage on money you owe',
'debt_interest_rate.data-tooltip': 'Extra percentage you pay on a bank loan or borrowing, like 10% (you can skip this if you don’t know).',
'auto_email.label': 'Send Me My Score by Email',
'auto_email.aria-label': 'Send score by email',
'auto_email.data-tooltip': 'Check this to get your financial health score sent to your email.',
'record_id.label': 'Select Record to Edit',
'record_id.choices.default': 'Create New Record',
...
'Want to learn more? Check out this course:': 'Want to learn more? Check out this course:',
...
'Failed to fetch record due to Google Sheets API limit': 'Failed to fetch record due to Google Sheets API limit',
'Failed to fetch record due to server error': 'Failed to fetch record due to server error',
'Failed to save data due to Google Sheets initialization error': 'Failed to save data due to Google Sheets initialization error',
'Failed to save data due to Google Sheets API limit': 'Failed to save data due to Google Sheets API limit',
'Failed to calculate running balance due to Google Sheets API limit': 'Failed to calculate running balance due to Google Sheets API limit',
'Failed to calculate running balance due to server error': 'Failed to calculate running balance due to server error',
'Invalid date format in bill schedule': 'Invalid date format in bill schedule',
'Failed to generate bill schedule due to server error': 'Failed to generate bill schedule due to server error',
'Failed to generate charts due to Google Sheets API limit': 'Failed to generate charts due to Google Sheets API limit',
'Failed to calculate average score due to Google Sheets API limit': 'Failed to calculate average score due to Google Sheets API limit',
'Failed to assign rank due to Google Sheets API limit': 'Failed to assign rank due to Google Sheets API limit',
'Failed to assign rank due to server error': 'Failed to assign rank due to server error',
...
'Please log in to perform this action': 'Please log in to perform this action',
'Transaction not found or unauthorized': 'Transaction not found or unauthorized',
'Failed to delete transaction due to Google Sheets error': 'Failed to delete transaction due to Google Sheets error',
'Failed to delete bill': 'Failed to delete bill',
'Failed to update bill status': 'Failed to update bill status',
'Bill marked as paid': 'Bill marked as paid',
'Failed to fetch data due to Google Sheets API limit': 'Failed to fetch data due to Google Sheets API limit',
'Your email is used to track your bills.': 'Your email is used to track your bills.',
...
'Provide your email address to receive your bill reminders.': 'Provide your email address to receive your bill reminders.',
'Describe what this bill is for.': 'Describe what this bill is for.',
'Enter the amount of the bill.': 'Enter the amount of the bill.',
'Select the date the bill is due.': 'Select the date the bill is due.',
'Select the category for this bill.': 'Select the category for this bill.',
'Disposal required': 'Disposal required',
'Choose how often this bill repeats.': 'Choose how often this bill repeats.',
'Select a record to edit, if applicable.': 'Select a record to edit, if applicable.',
...
'Select a previous budget to edit or start new.': 'Select a previous budget to edit or start new.',
...
'Ficore Africa Emergency Fund Report_here’s your Ficore Africa Emergency Fund analysis based on your recent submission.': 'Here’s your Ficore Africa Emergency Fund analysis based on your recent submission.',
'Start building your emergency fund to ensure financial security.': 'Start building your emergency fund to ensure financial security.',
'Emergency Fund Planner': 'Emergency Fund Planner',
'Plan Your Emergency Fund': 'Plan Your Emergency Fund',
'Get your emergency fund report by email.': 'Get your emergency fund report by email.',
'Your total monthly spending (e.g., rent, food, transport).': 'Your total monthly spending (e.g., rent, food, transport).',
'Plan Your Emergency Fund!': 'Plan Your Emergency Fund!',
'Planning your emergency fund...': 'Planning your emergency fund...',
...
'No transactions found. Add an expense to get started.': 'No transactions found. Add an expense to get started.',
'Expense Charts': 'Expense Charts',
'Add New Expense': 'Add New Expense',
'Track and manage your expenses to stay in control.': 'Track and manage your expenses to stay in control.',
'Save Expense': 'Save Expense',
'Saving your expense...': 'Saving your expense...',
'View Expense Summary': 'View Expense Summary',
'Your Financial Insights': 'Your Financial Insights',
'Ficore Africa Score Report': 'Ficore Africa Score Report',
...
'Follow the advice above to improve your financial health.': 'Follow the advice above to improve your financial health.',
'Ficore Africa Financial Health Score': 'Ficore Africa Financial Health Score',
'Get Your Score': 'Get Your Score',
'User Information': 'User Information',
'Financial Information': 'Financial Information',
'Send score by email': 'Send score by email',
'Select a previous record': 'Select a previous record',
...
'Organize bills by amount and due date': 'Organize bills by amount and manage due date',
'Manage and mark bills as paid': 'Manage and mark bills as paid',
'Go Back': 'Go Back',
'Ficore Africa Net Worth Report': 'Ficore Africa Net Worth Report',
'Here’s your Ficore Africa Net Worth analysis based on your recent submission.': 'Here’s your Ficore Africa Net Worth analysis based on your recent submission.',
'Rank Percentile': 'Rank Percentile',
'Consider the following advice to manage your finances:': 'Consider the following advice to manage your finances:',
'© 2025 Ficore Africa. All rights reserved.': '© 2025 Ficore Africa. All rights reserved.',
'Calculate Your Net Worth': 'Calculate Your Net Worth',
'Please select a record or choose to create a new one.': 'Please select a record or choose to create a new one.',
